package org.gwtproject.tutorial.client.main;
...
import org.gwtproject.tutorial.client.dialogs.Dialogs;
import org.gwtproject.tutorial.client.item.Item;
    ...
    private void restoreItems() {
        ...
        if (json != null && !json.isEmpty()) {
            ...
            for (int i = 0; i < restored.length(); i++) {
                ...
                addItem(p.get("title").toString(),p.get("notes").toString());
            }
        }
    }
